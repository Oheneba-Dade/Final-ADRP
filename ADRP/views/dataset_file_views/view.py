...
from backend_services.dataset_file_service.dataset_file_service_main import dataset_file_services
...
def upload_dataset_file(request):
    ...
    result = dataset_file_services.handle_file_upload(dataset_id, file_obj)
...
def delete_dataset_file(request):
    ...
    result = dataset_file_services.handle_file_delete(dataset_id, filename)
...
def update_dataset_file(request):
    ...
    result = dataset_file_services.handle_file_update(dataset_id, file_obj)
